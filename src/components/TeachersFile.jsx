...
const TeachersFile = () => {
  ...
  const handleFileChange = (event) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        const requiredColumns = ['mis_id', 'name', 'email', 'designation', 'subject_preferences'];
  ...
  return (
    <div className="upload-card">
      ...
      <p>Teachers File</p>
      <label htmlFor="teachers-file-upload" className="upload-button">
        Upload File
      </label>
      <input
        id="teachers-file-upload"
        type="file"
        accept=".csv, .xls, .xlsx"
