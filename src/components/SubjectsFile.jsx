...
const SubjectsFile = () => {
  ...
  const handleFileChange = (event) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        // Define required columns for SubjectsFile. Adjust as needed.
        const requiredColumns = ['code', 'name', 'department', 'semester' , 'weekly_load']; 
  ...
  return (
    <div className="upload-card">
      ...
      <p>Subjects File</p>
      <label htmlFor="subjects-file-upload" className="upload-button">
        Upload File
      </label>
      <input
        id="subjects-file-upload"
        type="file"
        accept=".csv, .xls, .xlsx"
